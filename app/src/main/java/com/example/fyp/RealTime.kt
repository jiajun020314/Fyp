...
class RealTime : AppCompatActivity(), TextToSpeech.OnInitListener {


    private val recognizedLabels = HashSet<String>()
    ...
    private val labelDelayMillis = 1500L // 1 second delay between labels
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textureView.surfaceTextureListener = object:TextureView.SurfaceTextureListener{
            ...
            override fun onSurfaceTextureUpdated(p0: SurfaceTexture) {
                ...
                var x: Int
                val spokenLabels = HashSet<String>()
